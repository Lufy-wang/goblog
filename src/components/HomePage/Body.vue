<template>
  <div id="page">
    ...
    <div id="page-header">
      ...
      <h2>
        <p>这是一个让大家分享各自的“旅途故事”的网站。</p>
      </h2>
    </div>

    <!-- todo: 进行更好的对于手机适配，目前需要进行对 HomeHeader 的编辑 -->
    <div id="page-text">
      <h2 id="text-1">
        在这里，你可以与其他游客分享你旅途上遇到的美景。
      </h2>
      <img
        id="img-1"
